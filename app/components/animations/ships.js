...
const FreightShips = () => {
  ...
  const variants = {
    start: {
      ...
      y: [-5, -2, -5, 0, -2, -4, 0, -1],  // Bobbing motion
      transition: {
        duration: 6,
          ...
          >
            ...
            <motion.div
              ...
              <button 
                ...
                <img src={ basePath + "/cargo-ship.png" } style={{ width: "100%", height: "100%" }}></img>
              </button>
            ...
            {/* Track replacement - Ocean */}
            <div
              style={{
                width: "500px",
                height: "60px",
                background: "linear-gradient(180deg, #0066cc 0%, #004d99 100%)", // Darker blue gradient
                borderRadius: "15px",
                position: "relative",
                overflow: "hidden",
                flexShrink: 0
                ...
                style={{
                  ...
                  backgroundImage: `
                    ...
                    radial-gradient(circle at 50% 100%, 
                      ...
                      transparent 50%)
                  `,
                  backgroundSize: "60px 40px, 50px 30px",  // Larger wave size
                  backgroundPosition: "0 bottom, 25px bottom",
                  backgroundRepeat: "repeat-x",
                  zIndex: 2
                }}
                animate={{
                  x: [0, -60],  // Increased movement range
                }}
                transition={{
                  duration: 2.5,  // Slightly slower for more prominent effect
                  repeat: Infinity,
                  ease: "linear"
                }}
              />
                ...
                style={{
                  ...
                  backgroundImage: `
                    radial-gradient(circle at 50% 100%, 
                      ...
                      transparent 55%)
                  `,
                  backgroundSize: "40px 25px",  // Medium sized waves
          ...
          {activeCars.map((car, originalIndex) => (
            <AnimatePresence mode="sync" key={`active-${car}`}>
              <motion.div
                ...
                style={{
                  width: "80px",  // Fixed width for trains
                  height: "80px", // Fixed height for trains
                  position: "absolute",
                  top: "-10px",
                  left: "20px",
                  zIndex: 2,
