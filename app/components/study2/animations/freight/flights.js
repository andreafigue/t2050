          ...
          >
            ...
            <motion.div
              ...
              <button 
                ...
                <img src={ basePath + "/cargo-plane.png" } style={{ width: "100%", height: "100%" }}></img>
              </button>
            ...
            <AnimatePresence mode="sync" key={`active-${car}`}>
              <motion.div
                ...
                style={{
                  ...
                  height: "60px",
                  position: "absolute",
                  top: "40px", // Adjust starting position to account for parabolic motion
                  left: "20px",
                  zIndex: 2,
                }}
                animate="start"
              ...
              >
                <img src={ basePath + "/cargo-plane.png" } style={{ 
                  width: "100%", 
                  height: "100%",
                }}></img>
              </motion.div>
