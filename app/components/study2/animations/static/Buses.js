          ...
          >
            ...
            <div style={{
              ...
              {/* <div style={{
                ...
                right: "15px",
                top: "8px",
                color: parseInt(eta.split(':')[0]) * 60 + parseInt(eta.split(':')[1]) > 60 ? "#ff4444" : "#4CAF50",
                fontSize: "14px",
                fontFamily: "digital, monospace",
                fontWeight: "bold"
              }}>
                ...
                onUpdate={(latest) => {
                  ...
                  if (latest.x >= endOfTrack - 3) {
                    ...
                    if (!countedBuses.includes(car)) {
                      const randomPeople = Math.floor(Math.random() * (82 - 12 + 1)) + 12;  // Random between 12-56 for buses
