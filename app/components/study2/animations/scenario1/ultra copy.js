...
const Scenario1Ultra = () => {
  ...
  const scaleFactor = useMemo(() => {
    if (width < 768) {
      return Math.min(1, (width - 20) / 800); // Using 600 as divisor for larger mobile visuals
    }
    return 1;
  }, [width]);
  ...
  useEffect(() => {
    ...
    const getRandomInterval = () => Math.floor(Math.random() * (6400 - 5000 + 1)) + 5000;
  ...
  const variants = {
    start: {
      x: [110, 175, 240, 305, endOfTrack],  // 5 equal steps to endOfTrack (375)
      transition: {
        duration: 5,
      ...
      <div style={{
        ...
        >
          ...
          <motion.div
            ...
            <button 
              ...
              <img src={ basePath + "/train_tunnel.png" } style={{ width: "100%", height: "100%" }}></img>
            </button>
          ...
          <div
            style={{
              ...
              flexShrink: 0,
              backgroundColor: "transparent",
              borderRadius: "30px",  // Rounded ends for tunnel effect
            }}
          >
            <svg
              width="100%"
            ...
            >
              ...
              <defs>
                <linearGradient id="tunnelGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                  ...
                  <stop offset="40%" style={{ stopColor: "#3a3a3a", stopOpacity: 1 }} />
                  <stop offset="60%" style={{ stopColor: "#2a2a2a", stopOpacity: 1 }} />
                  <stop offset="100%" style={{ stopColor: "#1a1a1a", stopOpacity: 1 }} />
                </linearGradient>
                <linearGradient id="wallGradient" x1="0%" y1="50%" x2="100%" y2="50%">
                  <stop offset="0%" style={{ stopColor: "#666", stopOpacity: 0.8 }} />
                  <stop offset="50%" style={{ stopColor: "#555", stopOpacity: 0.6 }} />
              ...
              {/* Track lines with metallic effect */}
              <line
                x1="0"
                y1="35"
                x2="500"
          ...
          {isMobile && (
            <button
              ...
              style={{
                position: "absolute",
                top: "85px",          // Position below the right square
                left: "605px",        // Align with the right square
            ...
            >
              <svg 
                width="28"           // Increased from 24px
                height="28"          // Increased from 24px
                viewBox="0 0 24 24" 
                fill="none" 
                stroke="currentColor" 
                strokeWidth="2"
        ...
        {activeCars.map((car, originalIndex) => (
          <AnimatePresence mode="sync" key={`active-${car}`}>
              ...
              onUpdate={(latest) => {
                ...
                if (latest.x >= endOfTrack - 3) {
                  ...
                  if (!countedTrains.includes(car)) {
                    const randomPeople = Math.floor(Math.random() * (300 - 164 + 1)) + 164;  // Random between 82-150 for trains
            ...
            >
              <img src={ basePath + "/uhs_train.png" } style={{ width: "100%", height: "100%" }}></img>
            </motion.div>
          </AnimatePresence>
        ))}
