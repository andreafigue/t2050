...
const Scenario1Trains = () => {
  ...
  // Determine mobile based on width (<768px)
  const isMobile = width < 768;  
  const [showMobileGraph, setShowMobileGraph] = useState(false);

  // Adjust scale factor for a larger appearance on mobile
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        marginBottom: "0",  // Simplified margin
                ...
                onUpdate={(latest) => {
                  ...
                  if (latest.x >= endOfTrack - 3) {
                    ...
                    if (!countedTrains.includes(car)) {
                      const randomPeople = Math.floor(Math.random() * (300 - 164 + 1)) + 164;
...
export default Scenario1Trains; 