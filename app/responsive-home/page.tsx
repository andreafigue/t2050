...
const DynamicWashingtonMapWithLineGraphs = dynamic(() => import('../components/responsive/Freight'), {
  ssr: false,
  loading: () => <p className="text-center py-6">Loading freight trends…</p>,
});
const DynamicChartComponent = dynamic(() => import('../components/responsive/hsr2'), {
  ssr: false,
